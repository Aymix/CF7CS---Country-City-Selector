<?php
// Template for city tag generator
?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description"><?php echo esc_html(__('Name should be the country field name followed by "-city" (e.g., if country field is "your-country", name this "your-country-city")', 'cf7cs-country-city-selector')); ?></p>
                    </td>
                </tr>
